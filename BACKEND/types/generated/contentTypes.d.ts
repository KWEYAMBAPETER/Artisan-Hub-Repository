...
export interface ApiArtWorkArtWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    artStatus: Schema.Attribute.Enumeration<['available', 'pending', 'sold']>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryOption: Schema.Attribute.Enumeration<
      ['pickup only', 'pickup and delivery']
    > &
      Schema.Attribute.DefaultTo<'pickup only'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventStatus: Schema.Attribute.Enumeration<['pending', 'approved']>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artworks: Schema.Attribute.Relation<'manyToMany', 'api::art-work.art-work'>;
    ...
    deliveryAddress: Schema.Attribute.Component<
      ...
      false
    >;
    deliveryType: Schema.Attribute.Enumeration<['pickup', 'home delivery']> &
      Schema.Attribute.DefaultTo<'pickup'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderCode: Schema.Attribute.UID;
    orderStatus: Schema.Attribute.Enumeration<
      ['placed', 'pending', 'fulfilled', 'cancelled', 'processing']
    > &
      Schema.Attribute.DefaultTo<'placed'>;
    paymentStatus: Schema.Attribute.Enumeration<['unpaid', 'paid', 'failed']> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    art_works: Schema.Attribute.Relation<'oneToMany', 'api::art-work.art-work'>;
